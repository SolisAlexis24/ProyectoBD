...
create or replace view empleados_jefes(empleado_id, nombre, apellidos, rfc, puesto)
...
create or replace view vuelos_cancelados(num_vuelo, comercial, carga, fecha_salida)
